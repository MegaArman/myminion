...
clientSystem.initialize = function () {
	...
	// clientSystem.registerEventData("myminion:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	// 	let pinkyEventData = clientSystem.createEventData("myminion:pinky");
	// 	pinkyEventData.data.narf = true;
	//
	// 	clientSystem.broadcastEvent("myminion:pinky", pinkyEventData);
	// }
}
